...
namespace hdcom
{
    ...
    public:
        ...
        uint8_t* Get2DTifImage_8bitPointer(std::string file, int outshape[2]);
        ...
        float* Get3DTifSequence_32bitPointer(std::vector<std::string> &filelist, int outshape[3], std::pair<int,int> slice_range); //lastslice is exclusive
