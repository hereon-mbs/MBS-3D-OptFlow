#ifndef OPTFLOW_GPU2D_H
#define OPTFLOW_GPU2D_H
...
namespace optflow
{
	class OptFlow_GPU2D : public OptFlowSolver
	{
	public:
		...
		virtual void get_psimap(float* outimg, int shape[3]);

	private:
		optflow_type *u, *du, *phi;
		optflow_type *confidence, *psi;
