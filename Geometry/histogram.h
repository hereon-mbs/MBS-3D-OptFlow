...
namespace histo
{
    ...
    public:
        ...
        void calculatehistogram(dtype *data, uint8_t *mask, int shape[3], int n_bins, dtype lowerbound, dtype upperbound, std::vector<double> &out_histobins, std::vector<double> &out_histoedges);
        ...
        float* calculate2DHistogram(float *frame0, float *frame1,  uint8_t *mask, int shape[3], std::vector<double> &histoedges0, std::vector<double> &histoedges1, int outshape[2]);
